...
<template>
  <header class="text-gray-600 body-font">
    <div
      class="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center"
    >
      <NuxtLink
        class="flex title-font font-medium items-center text-base-content mb-4 md:mb-0"
        href="/"
      >
        <img
      ...
      >
        <HeaderLink
          className="mr-5 hover:text-neutral-focus dark:hover:text-neutral-content"
          href="/post/page/1"
          :pathname="route.path"
          >Cerca</HeaderLink
        >
