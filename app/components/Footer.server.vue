    ...
    <div>
      ...
      <div class="social">
        <a aria-label="il mio profilo GitHub" href="https://github.com/moebiusmania" target="_blank"
          ...
          <svg role="img" aria-label="GitHub" fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a aria-label="il mio canale YouTube" href="https://www.youtube.com/channel/UCxaNVAQjuYZdpCrDukpVnxg"
          ...
          <svg role="img" aria-label="YouTube" fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <!-- <a href="https://threads.net/moebiusmania" target="_blank" rel="noopener noreferrer">
          <svg role="img" fill="currentColor" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision"
            text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd"
            clip-rule="evenodd" viewBox="0 0 512 512" width="24px" height="24px">
            <title>Threads</title>
            <path
        ...
        <a aria-label="il mio profilo Bluesky" href="https://bsky.app/profile/moebiusmania.bsky.social" target="_blank"
          ...
          <svg role="img" aria-label="Bluesky" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 -3.268 64 68.414"
