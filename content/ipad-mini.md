...
images:
  [
    "https://salvatorelaisa.blog/content/2024/ipad_mini_sora.webp",
  ]
---

![Immagine generata con Sora AI di un iPad Mini 6th gen appoggiato su una scrivania di legno.](/content/2024/ipad_mini_sora.webp)<small>_Immagine generata con Sora, il prompt è stato "an ipad mini 6th generation lying down in a wooden desk with an abstract wallpapaer, soft natural light, photorealistic scene"._</small>

I tablet hanno attraversato varie fasi e trasformazioni da quando sono stati introdotti per la prima volta quasi quindici anni fa, e anche se ammetto che non ero particolarmente convinto delle varianti da 7-8" al loro esordio, **oggi sono invece convinto che questo specifico fattore forma sia la vera rappresentazione del termine "PC portatile"**.

Sono stato senza tablet per qualche anno, poi verso la metà del 2022 volevo un pò rimetterci mano e presi un iPad Air (_mi pare di quarta generazione_), ma per quanto fosse validissimo, mi resi conto che la portabilità di un tablet da 10" non è molto diversa da quella di un laptop: devi **decidere** di portarlo con te e devi per forza avere una borsa o uno zaino con cui portarlo in giro.

Dopo un paio di mesi ho rivenduto l'iPad Air e preso un Mini... e ho capito di aver trovato il mio **"sweet spot"** tra portabilità e potenza.

## Perché lo trovo il fattore forma ideale

Partiamo dall'assunto basilare di quasi tutti i tablet: é più grande di uno smartphone (_e gli occhi ringraziano_) ma più piccolo di un laptop. Ma rispetto ai 10" ci sono altre cose che per me funzionano molto bene:

- posso metterlo nel marsupio, che nel periodo primavera/estate è la mia inseparabile tascona extra
- ci sta nelle tasche interne delle giacche, per i periodi più freddi
- la potenza di calcolo e le ottimizzazioni lato software sono più che sufficienti per un utilizzo "da passeggio"

quindi il più delle volte posso portarlo con me senza dovermi preparare una borsa extra e nonostante questo non ho mai la sensazione di aver tra le mani un device scarso/meno potente di quanto sarebbe un modello più grande.

Certo, fa praticamente le stesse cose che faresti con il telefono, ma le fai più comodamente e tra poco farò qualche esempio dei singoli casi...
...
- **clone Apple Pen** (_circa 30€_) - anche se lo uso principalente come device di "lettura" (_non sono uno che disegna o prende note "a mano"_) sto iniziando a rendermi conto di come una penna sia la cosa più vicina all'equivalente dei mouse su PC. Puoi farne a meno, ma hai qualche piccolo vantaggio sopratutto con le tab dei browser. E poi non occupa molto spazio agganciandosi magneticamente al tablet.
...
- **pellicola paper-like** - abbinata ad una penna, se vi piace avere una sensazione tattile simile a quella della carta o vi rilassa un rumore che sembra quello delle penne classiche su carta...
...
- **giochi "locali":** ovvero quelli che normalmente si installano dall'App Store. Ne ho pochi installati (_[Vampire Survivors](https://apps.apple.com/us/app/vampire-survivors/id6444525702) ed [Hearthstone](https://apps.apple.com/us/app/hearthstone/id625257520) per citarne un paio_), alcuni di questi anche con grafiche notevoli e devo dire che le performance si sono sempre dimostrate buone.
- **game streaming:** ovvero utilizzando servizi come [Xcloud](https://www.xbox.com/en-us/play) o [GeForce Now](https://play.geforcenow.com/mall/) per streammare giochi da internet o l'[app di Xbox](https://apps.apple.com/us/app/xbox/id736179781) per connettermi in remoto alla console e usarla come server di stream. Ovviamente qui l'incognita è la qualità della connessione, durante viaggi è abbastanza sconsigliabile ma quando poi ci si collega ad un WiFi "fisso" può essere un'opzione più che valida.
...
- [Brave](https://apps.apple.com/us/app/brave-browser-search-engine/id1052879175) - ormai da qualche anno il mio browser predefinito su ogni dispositivo. Affidabile, veloce e con qualche feature utile bultin come adblocker e possibilità di riprodurre video di Youtube anche a schermo bloccato o offline.
- [Mozilla VPN](https://apps.apple.com/us/app/mozilla-vpn-secure-private/id1489407738) - costa poco, è cross device, e Mozilla è abbastanza affidabile da questo punto di vista. Durante i viaggi e usando wifi di bar e locali, per me è un must.
- [Feedly](https://apps.apple.com/us/app/feedly-smart-news-reader/id396069556) - il mio feed reader di fiducia da quando sono rimasto orfano di Google Reader, insieme a Brave sono le mie due app principali di lettura.
- [Obsidian](https://apps.apple.com/us/app/obsidian-connected-notes/id1557175442) - come [già raccontato in un altro articolo](/post/second-brain), Obsidian ormai è il mio archivio di note e appunti quindi non può mancare su questo device! 🤓

oltre al già citato [Darkroom](https://apps.apple.com/us/app/darkroom-photo-video-editor/id953286746) e alcune delle app preinstallate su iPadOS come [Freeform](https://apps.apple.com/it/app/freeform/id6443742539) e [Reminders](https://apps.apple.com/us/app/reminders/id1108187841).

## In conclusione

Ci sono alcune cose che rovinano un pò il romanticismo di quanto detto finora:

- la posizione della fotocamera anteriore (_se fosse messa "sopra" quando il tablet è in orientamento landscape, sarebbe perfetta, ma invece..._)
...
- non tutte le ESIM italiane sono compatibili con il Mini
